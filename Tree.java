...
public class Tree<T> {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Tree) {
            ...
            if (!(other).getRoot().equals(this.getRoot()))
                return false;
            else if (getNumberOfDescendants(other.getRoot()) != getNumberOfDescendants(this.getRoot()))
                return false;
            else {
                List<Node<T>> other_children = other.getRoot().getChildren();
                List<Node<T>> this_children = this.getRoot().getChildren();
                int this_num_children = this.getNumberOfDescendants(this.getRoot());
